...
function twentytwelve_widgets_init() {
    ...
    $sp_cat_sidebar_id = register_sidebar( array(
        'name' => __( 'Category Header Widget Area', 'twentytwelve' ),
        'id' => 'sidebar-4',
        'description' => __( 'Appears in every category page in the header area below the category title and description', 'twentytwelve' ),
        'before_widget' => '<aside id="%1$s" class="widget %2$s">',
        'after_widget' => '</aside>',
        'before_title' => '<h3 class="widget-title">',
        'after_title' => '</h3>',
